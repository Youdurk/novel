<template>
    ...
    <el-row :gutter="10">
      <el-col :span="8" v-for="item in fantasy" :key="item.id" >
...
<div style="border: 3px solid #ccc;">
    <div style="height: 34px;background-color: aqua;">玄幻小说列表 <i class="el-icon-d-arrow-right"></i></div>
...
export default{
    ...
    methods:{
      load(){
        this.request.get("/novel/popular/fantasy").then(res =>{
          console.log(res.data)
          this.fantasy=res.data
        })
        this.request.get("/novel/page/fantasy",{params:{
